package fr.pacman.front.cinematic.react.client.rs.ui.handlers;
...
import fr.pacman.front.cinematic.react.client.rs.ui.generators.ReactClientRsUIGenerators;
 ...
 * @author MINARM
 */
public class ReactClientRsGeneratorsHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent p_event) throws ExecutionException {
		...
		while (v_iterator.hasNext()) {
			...
			if (v_selected instanceof IFile) {
				new ReactClientRsUIGenerators((IFile) v_selected).generate();
			}
		}
		return null;
	}
