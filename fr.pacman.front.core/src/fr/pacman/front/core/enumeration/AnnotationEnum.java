...
public enum AnnotationEnum {
	...
	WITH_CUSTOM_STYLE("WITH_CUSTOM_STYLE", ModelEnum.DSL_CINEMATIC, true),
	
	WITH_VALUE("WITH_VALUE", ModelEnum.DSL_CINEMATIC, true),
	
	WITH_RIGHT_ICON("WITH_RIGHT_ICON", ModelEnum.DSL_CINEMATIC, true),
	
	WITH_LEFT_ICON("WITH_LEFT_ICON", ModelEnum.DSL_CINEMATIC, true),
	
	WITH_LIBRARY_NAME("LIBRARY_NAME", ModelEnum.DSL_CINEMATIC, true),
	
	WITH_LINE_SELECT("WITH_LINE_SELECT", ModelEnum.DSL_CINEMATIC, true),
	
	WITH_URL_PARAMS("WITH_URL_PARAMS", ModelEnum.DSL_CINEMATIC, true),
