 ...
 * @author MINARM
 */
public class PageNamingRule extends PropertiesCategory {
...
//	private static final String c_idParam_classTest = "classTest";
	...
	protected PacmanProperty[] initPacmanProperties() {
		return new PacmanProperty[] { PacmanProperty.newRequired(c_idParam_pageDefault,
				new String[] { "[" + NotationDefinition.normeCamelCase() + "/]",
						"[" + NotationDefinition.normeCamelCase() + "/]" },
				"La norme a appliquer pour une page js par defaut") };
