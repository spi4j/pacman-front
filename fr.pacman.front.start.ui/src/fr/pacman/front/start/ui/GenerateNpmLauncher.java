 ...
 * @author MINARM
 */
public class GenerateNpmLauncher {
...
//	                File nodeModules = new File(p_projectDir, "node_modules");
//	                if (!nodeModules.exists()) {
//	                    out.println("Installation des dépendances via npm install...");
//	                    executeCommand(p_projectDir, out, p_npmExec, "install");
//	                } else {
//	                    out.println("node_modules existe déjà, npm install ignoré.");
//	                }
//
//	                // Lancer npm run dev si demandé
//	                if (p_runDev) {
//	                    out.println("Lancement de npm run dev...");
//	                    executeCommand(p_projectDir, out, p_npmExec, "run", "dev");
//	                }
